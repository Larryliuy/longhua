			...
			var picker = {
				init : function(){
					...
					for(var j=1; j<=12; j++){
						...
						monthStr += '<li class="'+sel+'" data-month="'+(j)+'">'+F.preZero(j)+'月</li>';
					}
				...
				renderHTML : function(id){
					...
					var html = '<div class="mt_mask mt_mask_'+id+'"></div><div class="mt_poppanel mt_poppanel_'+id+'"><div class="mt_panel"><div class="mt_confirm"><a href="javascript:void(0);" class="mt_cancel">取消</a><h3 class="mt_title">选择时间</h3><a href="javascript:void(0);" class="mt_ok">确定</a><a href="javascript:void(0);" class="mt_setnow">现在</a></div><div class="mt_body"><div class="mt_year"><ul><li class="mt_note">选择年份</li><li></li></ul></div><div class="mt_month"><ul><li class="mt_note">选择月份</li><li></li></ul></div><div class="mt_day"><ul><li class="mt_note">选择日期</li><li></li></ul></div><div class="mt_sepline"></div><div class="mt_hour"><ul><li class="mt_note">选择时</li><li></li></ul></div><div class="mt_minute"><ul><li class="mt_note">选择分</li><li></li></ul></div><div class="mt_second"><ul><li class="mt_note">选择秒</li><li></li></ul></div><div class="mt_indicate"></div><div class="mt_indicate cate2"></div></div></div></div>';
