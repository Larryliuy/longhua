...
SockJS = function() {
    ...
    y.prototype._try_next_protocol = function(b) {
        ...
        for (;;) {
            ...
            if (!e) return ! 1;
            if (y[e] && y[e].need_body === !0 && (!a.body || typeof a.readyState != "undefined" && a.readyState !== "complete")) return d._protocols.unshift(e),
